  ...
  Widget build(BuildContext context) {
    return Card(
                ...
                child: Padding(
                  ...
                  child: Row(
                      children: [
                      CircleAvatar(backgroundImage: item.imageUrl as ImageProvider<Object>, radius: 40),//CircleAvatar
                                  ...
                                  Row(
                                    ...
                                    children: [
                                       ElevatedButton(
                                        ...
                                        Text(item.quantity.toString(), style: const TextStyle(fontSize: 15)),
                                        ElevatedButton(
                                          onPressed: onAdd,
                                          style: ElevatedButton.styleFrom(backgroundColor: Colors.orange[200],shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(10)),

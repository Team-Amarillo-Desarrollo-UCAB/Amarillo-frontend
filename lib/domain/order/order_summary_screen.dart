...
class OrderDetailsView extends StatelessWidget {
  // Valores predeterminados (pueden ser dinámicos más adelante)
  final String orderId = "#221342";
  final String orderStatus = "Entregado"; // Cambiar según lógica
  final String paymentMethod = "Efectivo"; // Cambiar según lógica
  ...
  Widget build(BuildContext context) {
    ...
    // Detalles del estado de la orden
